          ...
          <div class="row mg-b-20">
            <div class="col-md">
              <div class="card card-body">
                <table class="table" id="myTable" id="myTable">
					    ...
					    <tr>
					      ...
					      <td>
					      	<div class="btn-group">
					      		...
					      		<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deletDivision{{$division->id}}">Delete</button>
					      	</div>

					      	<div class="modal fade" id="deletDivision{{$division->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
